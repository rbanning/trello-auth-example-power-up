...
const scopes: DynamicIdentity.IDynamicIdentityScope[] = [
  {
...
const dates = [
  new Date(2021, 1, 28),  //MONTHS ARE ZERO (0) INDEXED
  //todo: add more dates
];
...
const runTest = (index: number, scope: DynamicIdentity.IDynamicIdentityScope, dateParts: any) => {
